...
* Type: `string`
* Default: `'.'` (== [`process.cwd()`](https://nodejs.org/docs/latest/api/process.html#processcwd))
...
* Supported target formats:
    * absolute/relative path
    * `import:<id>` (resolve by [`import.meta.resolve`](https://nodejs.org/docs/latest/api/esm.html#importmetaresolvespecifier-parent))
    * `require:<id>` (resolve by [`require.resolve`](https://nodejs.org/docs/latest/api/modules.html#requireresolverequest-options))
